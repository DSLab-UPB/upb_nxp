...
// The Glow bundle when using the Softmax layer has the "__expf_finite"
// function/symbol unresolved. We define it here and use the standard
// implementation.
float __expf_finite(float f) {
  return exp(f);
}
