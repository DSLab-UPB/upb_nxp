This is a Glow Tool that can convert an Onnx model to a bundle. As such, all files should be placed under a new folder in /glow/tools. This folder should be added to CMakeListst.txt of /glow/tools.
